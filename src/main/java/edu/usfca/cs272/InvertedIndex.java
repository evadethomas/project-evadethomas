...
public class InvertedIndex {
	 ...
	 */
	public static void addCount(String path, Integer size) {
		if (size != 0) {
	 ...
	 */
	public static void addWord(String stem, String location, Integer count) {
	 ...
	 */
	public void writeCounts(Path counts, boolean hasText) throws IOException {
		if (hasText == true) {
